...
public class Yefira {
    ...
    public static void init() {
        LOGGER.info("Initializing Yefira Common for Minecraft 26.2...");
        com.mozi1924.yefira.compat.VersionCompat.setLevelCompat(new com.mozi1924.yefira.compat.v26.LevelCompat26());
        YefiraConfig.load();
