...
public class Yefira {
    ...
    public static void init() {
        LOGGER.info("Initializing Yefira Common for Minecraft 1.20.4...");
        com.mozi1924.yefira.compat.VersionCompat.setLevelCompat(new com.mozi1924.yefira.compat.v1204.LevelCompat1204());
        YefiraConfig.load();
