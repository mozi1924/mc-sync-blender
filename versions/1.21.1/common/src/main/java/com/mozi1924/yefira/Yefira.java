...
public class Yefira {
    ...
    public static void init() {
        LOGGER.info("Initializing Yefira Common for Minecraft 1.21.1...");
        com.mozi1924.yefira.compat.VersionCompat.setLevelCompat(new com.mozi1924.yefira.compat.v121.LevelCompat121());
        YefiraConfig.load();
