...
/**
 * Compatibility layer for Minecraft 1.21.4 rendering pipeline.
 */
public class RenderCompat {
    ...
    /**
     * Renders a wireframe box using 1.21.4 ShapeRenderer.
     */
    public static void renderLineBox(PoseStack poseStack, VertexConsumer lineBuffer, AABB box,
                                     float r, float g, float b, float a) {
        ShapeRenderer.renderLineBox(poseStack, lineBuffer, box, r, g, b, a);
    }
